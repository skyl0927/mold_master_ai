...
| 6 | The CLI generates real JSON and Markdown worksheet artifacts from the latest current packet. | `npm run operational:hitl:reviewer-worksheet` | CLI smoke | PASS | output `ready_for_human_review`, `targetDecisionInputsMissing=56`, `markdownLineCount=101` |
