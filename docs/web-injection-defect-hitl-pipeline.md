...
- 수집 보고서: `artifacts/web-injection-defect-cases-20260724T074014/collection-report.json`
...
- 웰드라인 Figure는 MDPI 논문 원문, 저자·문헌 인용, CC BY 4.0, PMC 오픈액세스 원장 ID와 비철회 상태를 함께 보존한다.
