...
supplemental rebuild requested three new calls and reused the other 32
observations by immutable hash.

- source/Vision high-confidence agreement: 18
...
The twelve reusable-license Web Case candidates are all priority-one source/Vision
agreements:

- burn: 3 at confidence 0.90, 0.91, and 0.94
- short shot: 2 at confidence 0.96 and 0.97
- flash: 3 at confidence 0.93, 0.96, and 0.98
- sink: 3 at confidence 0.76, 0.83, and 0.90
...
authoritative `imageinfo/extmetadata` API. Four MDPI figures carry `CC BY 4.0`,
article citations, and distinct non-retracted PMC open-access license records.
They are candidates, not benchmark truth.

If all twelve are independently confirmed, the seven-class minimum is covered
and the clean approved count rises from 8 to the 20-sample retirement gate.
