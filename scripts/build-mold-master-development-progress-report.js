...
const run = () => {
  ...
  console.log(JSON.stringify({
    ...
    webCards: report.summary.webCards ?? null,
    webTargetCards: report.summary.webTargetCards ?? null,
    webCommonAgentValidationPassed: report.summary.webCommonAgentValidationPassed ?? null,
    webHitlApprovalsMissing: report.summary.webHitlApprovalsMissing ?? null,
