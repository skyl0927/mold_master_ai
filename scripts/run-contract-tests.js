...
const result = spawnSync(process.execPath, [
    ...
    path.join(root, 'tests', 'visionCaptureWorkOrderPlan.test.js'),
    ...
    path.join(root, 'tests', 'operationalHitlPostImportValidationObservations.test.js'),
    path.join(root, 'tests', 'operationalHitlPostImportValidationManualObservations.test.js'),
    ...
    path.join(root, 'tests', 'webKnowledgeCommonAgentLearningPackage.test.js'),
    ...
    path.join(root, 'tests', 'reportExportReliabilityGate.test.js'),
