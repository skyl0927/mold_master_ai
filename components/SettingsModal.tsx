                ...
                >
                  ...
                  {operationalStatusBundleDisplay.reviewerWorksheetText && (
                    <div className="mt-2 rounded border border-lime-900/50 bg-lime-950/20 px-2 py-1">
                      ...
                      {operationalStatusBundleDisplay.reviewerWorksheetCursorText && (
                        <p className="mt-1 break-words text-[8px] font-bold text-lime-100">
                          {operationalStatusBundleDisplay.reviewerWorksheetCursorText}
                        </p>
                      )}
                      {operationalStatusBundleDisplay.reviewerWorksheetSlipTitle && (
                        <p className="mt-1 break-words text-[8px] font-bold text-emerald-100">
                          {operationalStatusBundleDisplay.reviewerWorksheetSlipTitle}
                        </p>
                      )}
                      {operationalStatusBundleDisplay.reviewerWorksheetSlipInstruction && (
                        <p className="mt-1 break-words text-[8px] text-emerald-100">
                          {operationalStatusBundleDisplay.reviewerWorksheetSlipInstruction}
                        </p>
                      )}
                      ...
                      {operationalStatusBundleDisplay.reviewerWorksheetCursorCommand && (
                        <p className="mt-1 break-words font-mono text-[8px] text-amber-100">
                          {operationalStatusBundleDisplay.reviewerWorksheetCursorCommand}
                        </p>
                      )}
