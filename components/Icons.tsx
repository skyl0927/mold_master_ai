...
// Fix: Made `children` optional to resolve TypeScript errors in icon components.
...
export const DownloadIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M12 3v13.5M8.25 12.75 12 16.5l3.75-3.75" />
        </svg>
    </IconWrapper>
);
...
export const ChatIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72c-1.133-.093-1.98-1.057-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097M16.5 9.75v-.75a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v.75" />
        </svg>
    </IconWrapper>
);
...
export const BotIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.5 1.591L5.25 14.25M9.75 3.104a2.25 2.25 0 00-2.25 2.25v4.316a2.25 2.25 0 00.5 1.591L9 14.25M9.75 3.104a2.25 2.25 0 012.25 2.25v4.316a2.25 2.25 0 01-.5 1.591L12 14.25m-2.25 0L9.75 15.75M5.25 14.25L3 16.5m2.25-2.25L7.5 12M12 14.25L14.25 16.5m-2.25-2.25L11.25 12m2.25 4.5l-1.5-1.5m-5.25-3l-1.5-1.5m1.5 1.5l1.5-1.5" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 18.75m-4.5 0a4.5 4.5 0 109 0 4.5 4.5 0 10-9 0" />
        </svg>
    </IconWrapper>
);
...
export const SquareOutlineIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const SquareFillIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
...
export const LineSolidIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
...
export const LineDashedIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M4 12h2m4 0h2m4 0h2m4 0h2" />
        </svg>
    </IconWrapper>
);
...
export const BlurIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9a3 3 0 100 6 3 3 0 000-6z" opacity="0.5" />
        </svg>
    </IconWrapper>
);
...
export const NumberIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v8m-3-4h6" stroke="transparent" />
            <text x="12" y="16" fontSize="12" textAnchor="middle" fill="currentColor" stroke="none">1</text>
        </svg>
    </IconWrapper>
);

export const CursorArrowIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const DiagonalLineIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const CalloutIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            {/* Simple callout icon: rectangle with an arrow pointing up */}
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h8M8 14h4m-7.5 4v-4H4a2 2 0 01-2-2V6a2 2 0 012-2h16a2 2 0 012 2v8a2 2 0 01-2 2h-4.5L12 22l-3.5-4z" />
        </svg>
    </IconWrapper>
);