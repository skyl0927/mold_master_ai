...
const rowsForEditableFile = ({ editableFile, fileText }) => {
  ...
  return decisions.map((decision, index) => ({
    ...
    causeLabels: csvListFor(decision?.causeLabels || decision?.suggestedCauseLabels),
    checkItems: csvListFor(decision?.checkItems || decision?.suggestedCheckItems),
    actions: csvListFor(decision?.actions || decision?.suggestedActions),
    editablePath: compact(editableFile.editablePath),
    verificationCommand: compact(editableFile.verifyCommand)
  }));
};
